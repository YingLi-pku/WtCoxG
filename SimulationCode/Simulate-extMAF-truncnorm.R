# sbatch -J truncnorm -t 1-0:0 --array=1-1080 -o log/%A_%a.log --wrap='Rscript Simulate-extMAF-truncnorm.R $SLURM_ARRAY_TASK_ID'
...
for(v in ((group-1)*10 + 1):(group*10)){
  ...
  outputfile = paste0("./SNPinfo_trunc/prev",prev,
                      "_her",h2,
                      "_bc",bc,
                      "_theta",theta,
                      "_n",n1,
